      ...
      try {
        let count = /[0-9]/g.test(args[1])
          ? !args[1] || args.length < 2
            ? Math.max(
                Math.ceil(
                  (100 - global.db.data.users[m.sender].healt) / usepotion
                ),
                1
              )
            : Math.max(args[1], 1)
        ...
        if (args[0] === "potion") {
          ...
          conn.reply(
            ...
            pickRandom([
              ...
              "Mau ngunain apa? Cuma bisa gunain potion :v",
              "Wih mau gunain apa kamu, kan hanya bisa potion",
              "Waduheck, hanya bisa potion",
              "lah, mau gunain apa?, kan hanya bisa potion",
            ]) +
              "\nContoh penggunaan: *" +
              usedPrefix +
              "use potion 1*",
