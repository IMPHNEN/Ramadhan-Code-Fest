    ...
    try {
      ...
      let count =
        args[1] && args[1].length > 0
          ? Math.min(9999999, Math.max(parseInt(args[1]), 1))
          : Math.min(1);
      let who = m.mentionedJid
        ? m.mentionedJid[0]
        : args[2].replace(/[@ .+-]/g, "").replace(" ", "") + "@s.whatsapp.net";
      if (!m.mentionedJid || !args[2])
        throw "Tag salah satu, atau ketik Nomernya!!";
        ...
        case "money":
          if (global.db.data.users[m.sender].money >= count * 1) {
            try {
              ...
              conn.reply(
                m.chat,
                `Berhasil mentransfer ${rpg.emoticon(
                  "money"
                )}money sebesar ${count}`.trim(),
                m
              );
            } catch (e) {
              global.db.data.users[m.sender].money += count * 1;
            ...
            conn.reply(
              m.chat,
              `Uang kamu tidak mencukupi untuk mentransfer ${rpg.emoticon(
                "money"
              )}Money sebesar ${count}`.trim(),
              m
            );
        ...
        case "potion":
          if (global.db.data.users[m.sender].potion >= count * 1) {
            try {
              ...
              conn.reply(
                m.chat,
                `Berhasil mentransfer ${count} ${rpg.emoticon(
                  "potion"
                )}Potion`.trim(),
                m
              );
            ...
            conn.reply(
              m.chat,
              `${rpg.emoticon("potion")}Potion kamu tidak cukup`.trim(),
              m
            );
          break;
        case "sampah":
          if (global.db.data.users[m.sender].sampah >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `${rpg.emoticon("sampah")}Sampah kamu tidak cukup`.trim(),
              m
            );
          break;
        case "diamond":
          if (global.db.data.users[m.sender].diamond >= count * 1) {
            ...
            conn.reply(
              m.chat,
              `${rpg.emoticon("diamond")}Diamond kamu kamu tidak cukup`.trim(),
              m
            );
          break;
        case "common":
          if (global.db.data.users[m.sender].common >= count * 1) {
            ...
            conn.reply(
              ...
              `${rpg.emoticon(
                "common"
              )}Common crate kamu kamu tidak cukup`.trim(),
              m
            );
          break;
        case "uncommon":
          if (global.db.data.users[m.sender].uncommon >= count * 1) {
            ...
            conn.reply(
              ...
              `${rpg.emoticon(
                "uncommon"
              )}Uncommon crate kamu kamu tidak cukup`.trim(),
              m
            );
          break;
        case "mythic":
          if (global.db.data.users[m.sender].mythic >= count * 1) {
            ...
            conn.reply(
              ...
              `${rpg.emoticon(
                "mythic"
              )}Mythic crate kamu kamu tidak cukup`.trim(),
              m
            );
          break;
        case "legendary":
          if (global.db.data.users[m.sender].legendary >= count * 1) {
            ...
            conn.reply(
              ...
              `${rpg.emoticon(
                "legendary"
              )}Legendary crate kamu kamu tidak cukup`.trim(),
              m
            );
          break;
        default:
      ...
      conn.reply(
        m.chat,
        `Format yang anda gunakan salah\n\nGunakan format ${usedPrefix}transfer <type> <jumlah> <@tag>\ncontoh penggunaan: *${usedPrefix}transfer money 100 @${
          m.sender.split`@`[0]
        }*`.trim(),
        m,
        { mentions: m.sender }
